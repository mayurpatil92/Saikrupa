...
.fl-node-<?php echo $id; ?> .fl-module-content .bc-product-archive__search-submit {
	...
	if ( ! empty( $settings->bc_refinery_search_button_background ) ) {
		printf( 'background-color: %s;', FLBuilderColor::hex_or_rgb( $settings->bc_refinery_search_button_background ) );
	}
	if ( ! empty( $settings->bc_refinery_search_button_text_color ) ) {
		printf( 'color: %s;', FLBuilderColor::hex_or_rgb( $settings->bc_refinery_search_button_text_color ) );
	}
	...
	foreach ( $props as $key => $value ) {
		if ( ! empty( $value ) ) {
			if ( 'border-color' === $key ) {
				$value = FLBuilderColor::hex_or_rgb( $value );
			}
...
.fl-node-<?php echo $id; ?> .fl-module-content .bc-product__brand {
	<?php printf( 'color: %s;', FLBuilderColor::hex_or_rgb( $settings->bc_brand_text_color ) ); ?>
}
...
.fl-node-<?php echo $id; ?> .fl-post-grid-post .on_sale .bc-product__original-price,
.fl-node-<?php echo $id; ?> .fl-post-grid-post .bc-product__price {
	<?php printf( 'color: %s', FLBuilderColor::hex_or_rgb( $settings->bc_price_form['original_price_text_color'] ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .fl-post-feed-post .on_sale .bc-product__price,
.fl-node-<?php echo $id; ?> .fl-post-grid-post .on_sale .bc-product__price {
	<?php printf( 'color: %s', FLBuilderColor::hex_or_rgb( $settings->bc_price_form['sale_price_text_color'] ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .fl-post-grid-post .bc-product-flag--sale {
	background-color: <?php printf( '%s', FLBuilderColor::hex_or_rgb( $settings->bc_sale_background_color ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .fl-post-feed-post .bc-product-flag--sale,
.fl-node-<?php echo $id; ?> .fl-post-grid-post .bc-product-flag--sale {
	color: <?php printf( '%s', FLBuilderColor::hex_or_rgb( $settings->bc_sale_text_color ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .fl-post-feed-post .bc-single-product__reviews-anchor,
.fl-node-<?php echo $id; ?> .fl-post-grid-post .bc-single-product__reviews-anchor {
	color: <?php printf( '%s', FLBuilderColor::hex_or_rgb( $settings->bc_rating_form->bc_link_color ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .fl-post-grid-post .bc-single-product__reviews-anchor:hover {
	color: <?php printf( '%s', FLBuilderColor::hex_or_rgb( $settings->bc_rating_form->bc_link_hover_color ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .bc-single-product__rating--bottom {
	color: <?php printf( '%s', FLBuilderColor::hex_or_rgb( $settings->bc_rating_form->bc_star_background ) ); ?>;
}
...
.fl-node-<?php echo $id; ?> .bc-single-product__rating--top {
	color: <?php printf( '%s', FLBuilderColor::hex_or_rgb( $settings->bc_rating_form->bc_star_foreground ) ); ?>;
}
<?php endif; ?>
...
.fl-node-<?php echo $id; ?> .fl-post-grid-post .bc-product-form__modifiers,
.fl-node-<?php echo $id; ?> .fl-post-grid-post .bc-product-form__quantity-label {
	color: <?php printf( '%s', FLBuilderColor::hex_or_rgb( $settings->bc_cart_form['bc_form_text_color'] ) ); ?>;
}
